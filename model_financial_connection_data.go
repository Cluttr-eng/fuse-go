...
type _FinancialConnectionData FinancialConnectionData
...
func (o *FinancialConnectionData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionData := _FinancialConnectionData{}

	err = json.Unmarshal(bytes, &varFinancialConnectionData)

	if err != nil {
		return err
	}

	*o = FinancialConnectionData(varFinancialConnectionData)
