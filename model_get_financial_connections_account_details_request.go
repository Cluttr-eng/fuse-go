...
func (o *GetFinancialConnectionsAccountDetailsRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetFinancialConnectionsAccountDetailsRequest)
