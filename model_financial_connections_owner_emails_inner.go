...
type _FinancialConnectionsOwnerEmailsInner FinancialConnectionsOwnerEmailsInner
...
func (o *FinancialConnectionsOwnerEmailsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionsOwnerEmailsInner := _FinancialConnectionsOwnerEmailsInner{}

	err = json.Unmarshal(bytes, &varFinancialConnectionsOwnerEmailsInner)

	if err != nil {
		return err
	}

	*o = FinancialConnectionsOwnerEmailsInner(varFinancialConnectionsOwnerEmailsInner)
