...
type _EvalConsumerRiskReportRequestEventsInner EvalConsumerRiskReportRequestEventsInner
...
func (o *EvalConsumerRiskReportRequestEventsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	varEvalConsumerRiskReportRequestEventsInner := _EvalConsumerRiskReportRequestEventsInner{}

	err = json.Unmarshal(bytes, &varEvalConsumerRiskReportRequestEventsInner)

	if err != nil {
		return err
	}

	*o = EvalConsumerRiskReportRequestEventsInner(varEvalConsumerRiskReportRequestEventsInner)
