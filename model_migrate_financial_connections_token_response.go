...
func (o *MigrateFinancialConnectionsTokenResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMigrateFinancialConnectionsTokenResponse)
