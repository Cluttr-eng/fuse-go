...
func (o *CreateConsumerRiskReportCustomizationRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCreateConsumerRiskReportCustomizationRequest)
