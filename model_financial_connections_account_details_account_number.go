...
func (o *FinancialConnectionsAccountDetailsAccountNumber) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varFinancialConnectionsAccountDetailsAccountNumber)
