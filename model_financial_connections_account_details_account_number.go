...
type _FinancialConnectionsAccountDetailsAccountNumber FinancialConnectionsAccountDetailsAccountNumber
...
func (o *FinancialConnectionsAccountDetailsAccountNumber) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionsAccountDetailsAccountNumber := _FinancialConnectionsAccountDetailsAccountNumber{}

	err = json.Unmarshal(bytes, &varFinancialConnectionsAccountDetailsAccountNumber)

	if err != nil {
		return err
	}

	*o = FinancialConnectionsAccountDetailsAccountNumber(varFinancialConnectionsAccountDetailsAccountNumber)
