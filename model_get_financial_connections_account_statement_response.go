...
func (o *GetFinancialConnectionsAccountStatementResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetFinancialConnectionsAccountStatementResponse)
