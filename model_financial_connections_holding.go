...
type _FinancialConnectionsHolding FinancialConnectionsHolding
...
func (o *FinancialConnectionsHolding) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionsHolding := _FinancialConnectionsHolding{}

	err = json.Unmarshal(bytes, &varFinancialConnectionsHolding)

	if err != nil {
		return err
	}

	*o = FinancialConnectionsHolding(varFinancialConnectionsHolding)
