...
type _CreateLinkTokenRequest CreateLinkTokenRequest
...
func (o *CreateLinkTokenRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCreateLinkTokenRequest := _CreateLinkTokenRequest{}

	err = json.Unmarshal(bytes, &varCreateLinkTokenRequest)

	if err != nil {
		return err
	}

	*o = CreateLinkTokenRequest(varCreateLinkTokenRequest)
