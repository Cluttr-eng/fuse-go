...
type _GetConsumerRiskReportResponse GetConsumerRiskReportResponse
...
func (o *GetConsumerRiskReportResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetConsumerRiskReportResponse := _GetConsumerRiskReportResponse{}

	err = json.Unmarshal(bytes, &varGetConsumerRiskReportResponse)

	if err != nil {
		return err
	}

	*o = GetConsumerRiskReportResponse(varGetConsumerRiskReportResponse)
