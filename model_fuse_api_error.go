...
type _FuseApiError FuseApiError
...
func (o *FuseApiError) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFuseApiError := _FuseApiError{}

	err = json.Unmarshal(bytes, &varFuseApiError)

	if err != nil {
		return err
	}

	*o = FuseApiError(varFuseApiError)
