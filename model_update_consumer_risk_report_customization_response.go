...
type _UpdateConsumerRiskReportCustomizationResponse UpdateConsumerRiskReportCustomizationResponse
...
func (o *UpdateConsumerRiskReportCustomizationResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUpdateConsumerRiskReportCustomizationResponse := _UpdateConsumerRiskReportCustomizationResponse{}

	err = json.Unmarshal(bytes, &varUpdateConsumerRiskReportCustomizationResponse)

	if err != nil {
		return err
	}

	*o = UpdateConsumerRiskReportCustomizationResponse(varUpdateConsumerRiskReportCustomizationResponse)
