...
func (o *UpdateConsumerRiskReportCustomizationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varUpdateConsumerRiskReportCustomizationResponse)
