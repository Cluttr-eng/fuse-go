...
func (o *CreateConsumerRiskReportCustomizationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varCreateConsumerRiskReportCustomizationResponse)
