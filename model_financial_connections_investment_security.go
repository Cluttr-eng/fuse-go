...
type _FinancialConnectionsInvestmentSecurity FinancialConnectionsInvestmentSecurity
...
func (o *FinancialConnectionsInvestmentSecurity) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionsInvestmentSecurity := _FinancialConnectionsInvestmentSecurity{}

	err = json.Unmarshal(bytes, &varFinancialConnectionsInvestmentSecurity)

	if err != nil {
		return err
	}

	*o = FinancialConnectionsInvestmentSecurity(varFinancialConnectionsInvestmentSecurity)
