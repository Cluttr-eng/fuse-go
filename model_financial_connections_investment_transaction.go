...
func (o *FinancialConnectionsInvestmentTransaction) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFinancialConnectionsInvestmentTransaction)
