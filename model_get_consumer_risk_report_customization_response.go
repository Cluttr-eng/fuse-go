...
type _GetConsumerRiskReportCustomizationResponse GetConsumerRiskReportCustomizationResponse
...
func (o *GetConsumerRiskReportCustomizationResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetConsumerRiskReportCustomizationResponse := _GetConsumerRiskReportCustomizationResponse{}

	err = json.Unmarshal(bytes, &varGetConsumerRiskReportCustomizationResponse)

	if err != nil {
		return err
	}

	*o = GetConsumerRiskReportCustomizationResponse(varGetConsumerRiskReportCustomizationResponse)
