...
func (o *GetFinancialConnectionsOwnersResponseAccountsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetFinancialConnectionsOwnersResponseAccountsInner)
