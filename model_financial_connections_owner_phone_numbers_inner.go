...
type _FinancialConnectionsOwnerPhoneNumbersInner FinancialConnectionsOwnerPhoneNumbersInner
...
func (o *FinancialConnectionsOwnerPhoneNumbersInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionsOwnerPhoneNumbersInner := _FinancialConnectionsOwnerPhoneNumbersInner{}

	err = json.Unmarshal(bytes, &varFinancialConnectionsOwnerPhoneNumbersInner)

	if err != nil {
		return err
	}

	*o = FinancialConnectionsOwnerPhoneNumbersInner(varFinancialConnectionsOwnerPhoneNumbersInner)
