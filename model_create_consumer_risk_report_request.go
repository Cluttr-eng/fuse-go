...
type _CreateConsumerRiskReportRequest CreateConsumerRiskReportRequest
...
func (o *CreateConsumerRiskReportRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCreateConsumerRiskReportRequest := _CreateConsumerRiskReportRequest{}

	err = json.Unmarshal(bytes, &varCreateConsumerRiskReportRequest)

	if err != nil {
		return err
	}

	*o = CreateConsumerRiskReportRequest(varCreateConsumerRiskReportRequest)
