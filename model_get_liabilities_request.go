...
type _GetLiabilitiesRequest GetLiabilitiesRequest
...
func (o *GetLiabilitiesRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetLiabilitiesRequest := _GetLiabilitiesRequest{}

	err = json.Unmarshal(bytes, &varGetLiabilitiesRequest)

	if err != nil {
		return err
	}

	*o = GetLiabilitiesRequest(varGetLiabilitiesRequest)
