...
type _FinancialConnectionDetailsAkoya FinancialConnectionDetailsAkoya
...
func (o *FinancialConnectionDetailsAkoya) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFinancialConnectionDetailsAkoya := _FinancialConnectionDetailsAkoya{}

	err = json.Unmarshal(bytes, &varFinancialConnectionDetailsAkoya)

	if err != nil {
		return err
	}

	*o = FinancialConnectionDetailsAkoya(varFinancialConnectionDetailsAkoya)
