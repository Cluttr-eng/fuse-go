...
type _GetInvestmentHoldingsResponse GetInvestmentHoldingsResponse
...
func (o *GetInvestmentHoldingsResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetInvestmentHoldingsResponse := _GetInvestmentHoldingsResponse{}

	err = json.Unmarshal(bytes, &varGetInvestmentHoldingsResponse)

	if err != nil {
		return err
	}

	*o = GetInvestmentHoldingsResponse(varGetInvestmentHoldingsResponse)
