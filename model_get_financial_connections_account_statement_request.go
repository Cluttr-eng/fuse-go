...
func (o *GetFinancialConnectionsAccountStatementRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetFinancialConnectionsAccountStatementRequest)
