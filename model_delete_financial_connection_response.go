...
type _DeleteFinancialConnectionResponse DeleteFinancialConnectionResponse
...
func (o *DeleteFinancialConnectionResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDeleteFinancialConnectionResponse := _DeleteFinancialConnectionResponse{}

	err = json.Unmarshal(bytes, &varDeleteFinancialConnectionResponse)

	if err != nil {
		return err
	}

	*o = DeleteFinancialConnectionResponse(varDeleteFinancialConnectionResponse)
